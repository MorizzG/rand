...
unif01_Gen* unif01_CreateCombAdd2(unif01_Gen* gen1, unif01_Gen* gen2, char* name);

unif01_Gen* unif01_CreateCombAdd3(unif01_Gen* gen1, unif01_Gen* gen2, unif01_Gen* gen3, char* name);

unif01_Gen* unif01_CreateCombXor2(unif01_Gen* gen1, unif01_Gen* gen2, char* name);

unif01_Gen* unif01_CreateCombXor3(unif01_Gen* gen1, unif01_Gen* gen2, unif01_Gen* gen3, char* name);
...
void unif01_TimerGen(unif01_Gen* gen, unif01_TimerRec* timer, long n, lebool fU01);

void unif01_TimerSumGen(unif01_Gen* gen, unif01_TimerRec* timer, long n, lebool fU01);
